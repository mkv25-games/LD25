...
class HeaterRoomProcess extends StandardProcess
{	
	...
	{		
		...
		for (employee in employees)
		{
			...
			if (employee.geneticQuality.value > employee.geneticQuality.min)
			{
				employee.geneticQuality.subtract(5);
			}
	...
	override public function interact(recruit:TestSubject):Void
	{
		...
		rewardScreens.showImage(RewardScreens.RS08_FUTURE_COOLING);
	}
